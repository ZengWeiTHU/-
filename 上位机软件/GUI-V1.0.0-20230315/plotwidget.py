...
class plotWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.canvas.axes1.plot(t, partData[0] + y1,label='浮取脉象',c='m')
        self.canvas.axes2.plot(t, partData[1] + y2,label='中取脉象',c='m')
        self.canvas.axes3.plot(t, partData[2] + y3,label='沉取脉象',c='m')
