...
class plotWidget2(QWidget):
    def __init__(self, parent=None):
        ...
        self.canvas.axes1.plot(t, partData[0],label='浮取脉象',c='g')
        self.canvas.axes2.plot(t, partData[1],label='中取脉象',c='g')
        self.canvas.axes3.plot(t, partData[2],label='沉取脉象',c='g')
