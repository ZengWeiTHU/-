...
class plotWidget3(QWidget):
    def __init__(self, parent=None):
        ...
        self.canvas.axes1.plot(t, X,label='浮取脉象',c='b')
        self.canvas.axes2.plot(t, partData[1],label='中取脉象',c='b')
        self.canvas.axes3.plot(t, partData[2],label='沉取脉象',c='b')
